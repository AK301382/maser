...
import { MapPin, Navigation, Plus, Check, Crosshair } from 'lucide-react';
...
// Component to get map center when adding point
    ...
    return (
      <div className="h-full relative" data-testid="map-drawing-view">
        ...
        >
          ...
          />
          <LocationButton />
          <MapCenterTracker mapRef={mapRef} />
                ...
                <div className="flex items-start space-x-3 space-x-reverse">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-gray-900">
                      نقشه را حرکت دهید و دکمه افزودن را بزنید
                    </p>
          ...
          <div className="bg-teal-50 border border-teal-200 rounded-lg p-4 space-y-2">
            ...
            <ul className="text-sm text-teal-800 space-y-1">
              <li className="flex items-start space-x-2 space-x-reverse">
                ...
                <span>نقشه را حرکت دهید و علامت + را روی جاده قرار دهید</span>
              </li>
              <li className="flex items-start space-x-2 space-x-reverse">
                <span className="text-teal-600 font-bold">۲.</span>
                <span>دکمه "افزودن نقطه" را بزنید تا نقطه ثبت شود</span>
              </li>
              <li className="flex items-start space-x-2 space-x-reverse">
                <span className="text-teal-600 font-bold">۳.</span>
                <span>نام و نوع جاده را وارد کرده و ثبت کنید</span>
              </li>
              <li className="flex items-start space-x-2 space-x-reverse">
                <span className="text-teal-600 font-bold">۴.</span>
                <span>بعد از تایید مدیر، سکه دریافت کنید</span>
              </li>
            </ul>
          </div>
